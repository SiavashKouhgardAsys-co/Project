...
namespace MoshaverAmlak.DataLayer.Migrations
{
    ...
    [Migration("20210129120903_GenerateDatabaseV02")]
    partial class GenerateDatabaseV02
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MoshaverAmlak.DataLayer.Entity.AirConditioner", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MoshaverAmlak.DataLayer.Entity.BalconyPlace", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("BalconyPlace");
                });

            modelBuilder.Entity("MoshaverAmlak.DataLayer.Entity.BuildingFacade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MoshaverAmlak.DataLayer.Entity.CWType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MoshaverAmlak.DataLayer.Entity.Cupboard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MoshaverAmlak.DataLayer.Entity.DoorOpenerType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MoshaverAmlak.DataLayer.Entity.FloorMaterial", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MoshaverAmlak.DataLayer.Entity.HeatingType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MoshaverAmlak.DataLayer.Entity.HotWaterType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MoshaverAmlak.DataLayer.Entity.Room", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MoshaverAmlak.DataLayer.Entity.TypeHome", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MoshaverAmlak.DataLayer.Entity.RealEstate_User", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("RealEstate_User");
                });
            ...
            modelBuilder.Entity("MoshaverAmlak.DataLayer.Entity.HomeFile", b =>
                {
                    b.HasOne("MoshaverAmlak.DataLayer.Entity.AirConditioner", "AirConditioner")
                        .WithMany("HomeFiles")
                        .HasForeignKey("AirConditionerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MoshaverAmlak.DataLayer.Entity.BalconyPlace", "BalconyPlace")
                        .WithMany("HomeFiles")
                        .HasForeignKey("BalconyPlaceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MoshaverAmlak.DataLayer.Entity.BuildingFacade", "BuildingFacade")
                        .WithMany("HomeFiles")
                        .HasForeignKey("BuildingFacadeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MoshaverAmlak.DataLayer.Entity.CWType", "CWType")
                        .WithMany("HomeFiles")
                        .HasForeignKey("CWTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("MoshaverAmlak.DataLayer.Entity.Cupboard", "Cupboard")
                        .WithMany("HomeFiles")
                        .HasForeignKey("CupboardId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MoshaverAmlak.DataLayer.Entity.DoorOpenerType", "DoorOpenerType")
                        .WithMany("HomeFiles")
                        .HasForeignKey("DoorOpenerTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("MoshaverAmlak.DataLayer.Entity.FloorMaterial", "FloorMaterial")
                        .WithMany("HomeFiles")
                        .HasForeignKey("FloorMaterialId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MoshaverAmlak.DataLayer.Entity.HeatingType", "HeatingType")
                        .WithMany("HomeFiles")
                    ...
                    b.HasOne("MoshaverAmlak.DataLayer.Entity.HotWaterType", "HotWaterType")
                        .WithMany("HomeFiles")
                        .HasForeignKey("HotWaterTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("MoshaverAmlak.DataLayer.Entity.Room", "Room")
                        .WithMany("HomeFiles")
                        .HasForeignKey("RoomId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MoshaverAmlak.DataLayer.Entity.TypeHome", "TypeHome")
                        .WithMany("HomeFiles")
                        .HasForeignKey("TypeHomeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
